...
now_ipaddress="wss://yuyin.jay-zjy.cn:10095";
...
function on_recoder_mode_change()
{
		    ...
		    if(item=="mic")
			{
				document.getElementById("mic_mode_div").style.display = 'none'; // 隐藏ASR模型模式
...
// 处理语音识别结果文本，过滤语言标记和情感标记
function cleanSpeechText(text) {
	// 使用正则表达式提取 <|语言|><|情感|><|类型|> 后面的实际文本内容
